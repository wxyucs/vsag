...
int ip_kmeans() {
    ...
    std::cout << "loss:" << vsag::kmeans_clustering(dim, max_elements, clusters, data, centroids, "ip") << std::endl;
...
int l2_kmeans() {
    ...
    float * centroids = new float[dim * clusters];
    std::cout << "loss:" << vsag::kmeans_clustering(dim, max_elements, clusters, data, centroids, "l2") << std::endl;
